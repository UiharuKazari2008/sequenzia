...
const infodialog = '<div class="info-dialog-container" data-simplebar>\n' +
    ...
    '                id="infoDialoggoToDownload" href="#__" role="button" target="_blank" rel="noopener noreferrer"><i class="infoDialog-icon fas fa-download shadow-text"></i></a><a class="btn text-white" id="infoDialogmakeOffline" href="#__" role="button"><i class="infoDialog-icon fas fa-bookmark shadow-text"></i></a></div>\n' +
    '    <div\n' +
