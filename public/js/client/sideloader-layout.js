...
const infodialog = '<div class="info-dialog-container">\n' +
    ...
    '    </div>\n' +
    '    <div class="row px-2 flex-nowrap mb-1 mt-2" style="display: flex; justify-content: space-evenly; align-content: center; flex-direction: row; align-items: center;"><a class="btn text-white" id="infoDialogtoggleFavoritePost" role="button" href="#__" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Favorite Post"><i class="infoDialog-icon fas fa-star shadow-text"></i></a><a class="btn text-white"\n' +
    '            id="infoDialogaddFlagPost" role="button" href="#__" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Flag Post"><i class="infoDialog-icon fas fa-flag shadow-text"></i></a><a class="btn text-white" id="infoDialoggoToPostLocation"\n' +
    '            href="#__" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Go to Posts Location"><i class="infoDialog-icon fas fa-directions shadow-text"></i></a><a class="btn text-white hidden" id="infoDialoggoToPostSource"\n' +
    '            href="#__" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Go to Posts Source"><i class="infoDialog-icon fas fa-link shadow-text"></i></a><a class="btn text-white" id="infoDialoggoToHistoryDisplay" href="#__"\n' +
    '            role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Go to Display History"><i class="infoDialog-icon fas fa-history shadow-text"></i></a><a class="btn text-white" id="infoDialoggoToPlay" href="#__" role="button"\n' +
    '            data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Play File"><i class="infoDialog-icon fas fa-play shadow-text"></i></a><a class="btn text-white" id="infoDialoggoToDownload" href="#__" role="button" target="_blank" rel="noopener noreferrer"\n' +
    '            data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Download File"><i class="infoDialog-icon fas fa-download shadow-text"></i></a><a class="btn text-white" id="infoDialogmakeOffline" href="#__" role="button" data-tooltip="tooltip"\n' +
    '            data-trigger="hover" data-placement="top" title="Save Post to Local Storage"><i class="infoDialog-icon fas fa-folder-bookmark shadow-text"></i></a></div>\n' +
    '    <div class="row pl-3 pr-3 hidden" id="infoDialogkeepExpireingFile"><a class="btn btn-primary mb-2 w-100" data-toggle="collapse" href="#__" role="button"><i class="fas fa-clock pr-2"></i><span>Keep Offline File</span></a></div>\n' +
    ...
    '            <div class="card-ui p-1" style="max-height: 600px; overflow-x: hidden; overflow-y: auto; overflow-wrap: anywhere"></div>\n' +
    '        </div>\n' +
    '    </div>\n' +
    ...
    '    </div>\n' +
    '    <div class="row px-3 mb-2">\n' +
    '        <div class="mt-1 infoGrid"><a class="btn btn-primary hidden" id="infoDialogsearchUseChannel" href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Use this folder"><i class="fas fa-folder"></i></a><a class="btn btn-primary hidden"\n' +
    '                id="infoDialogsausenaoRequest" href="#__" target="_blank" rel="noopener noreferrer" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search SauseNAO (External)"><i class="fas fa-telescope"></i></a><a class="btn btn-primary hidden"\n' +
    '                id="infoDialogsearchByParent" href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search the parent post"><i class="fas fa-level-up-alt"></i></a><a class="btn btn-primary hidden" id="infoDialogsearchByUser"\n' +
    '                href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search this user"><i class="fas fa-user"></i></a><a class="btn btn-primary hidden" id="infoDialogsearchByColor" href="#_" role="button" data-tooltip="tooltip"\n' +
    '                data-trigger="hover" data-placement="top" title="Search by color"><i class="fas fa-swatchbook"></i></a><a class="btn btn-primary hidden" id="infoDialogsearchByID" href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top"\n' +
    '                title="Search by related IDs"><i class="fas fa-asterisk"></i></a><a class="btn btn-primary hidden" id="infoDialogsearchByContents" href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search by post text"><i class="fas fa-font-case"></i></a>\n' +
    '            <a\n' +
    '                class="btn btn-primary" id="infoDialogsearchSelectedText" href="#_" role="button" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search by selected text"><i class="fas fa-i-cursor"></i></a>\n' +
    '        </div>\n' +
    '    </div>\n' +
    '    <div class="row px-3 mb-2">\n' +
    '        <div class="btn-group btn-group-toggle mt-2 w-100" id="infoDialogtagLocationSelection" data-toggle="buttons"><label class="btn btn-sm btn-info w-100" id="infoDialogtagFilterPost" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search using within Posts Location"><input type="radio" name="options" autocomplete="off" data-search-location="" checked=""/><span> Post</span></label>\n' +
    '            <label\n' +
    '                class="btn btn-sm btn-info w-100 active" id="infoDialogtagFilterCurrent" data-tooltip="tooltip" data-trigger="hover" data-placement="top" title="Search using the current pages query and restrictions"><input type="radio" name="options" autocomplete="off" data-search-location="" /><span> Session</span></label><label class="btn btn-sm btn-info w-100" id="infoDialogtagFilterEverywhere" data-tooltip="tooltip" data-trigger="hover" data-placement="top"\n' +
    '                    title="Search the whole server"><input type="radio" name="options" autocomplete="off" data-search-location=""/><span> Everywhere</span></label></div>\n' +
    '    </div>\n' +
