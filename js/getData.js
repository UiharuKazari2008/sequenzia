...
module.exports = async (req, res, next) => {
    ...
    if (req.session.active_exchange && req.session.active_exchange !== 'master') {
        ...
        sqlWhere = [
            `((kanmi_records.n_channel IS NULL AND kanmi_records.channel = ${thisUser.master.cache.channels_view}.channelid) OR (kanmi_records.n_channel = ${thisUser.master.cache.channels_view}.channelid))`,
